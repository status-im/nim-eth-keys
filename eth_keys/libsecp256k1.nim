...
proc recoverPublicKey*(data: openarray[byte],
  ...
  rawkey.header = 0x04 # mark key with UNCOMPRESSED flag
  copyMem(addr rawkey.data[0], unsafeAddr data[0], len(rawkey.data))
